...
import com.example3t.appbandoan.Main.thongtinsanpham;
...
public class MonanvatAd extends RecyclerView.Adapter<MonanvatAd.holderhv> {
    Context context;
    List<mathang> array;


    public MonanvatAd(Context context, List<mathang> array) {
