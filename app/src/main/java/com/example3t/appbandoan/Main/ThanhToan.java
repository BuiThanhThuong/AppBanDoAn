...
import com.example3t.appbandoan.adapter.GioHangad;
import com.example3t.appbandoan.adapter.thanhtoanad1;
...
import com.example3t.appbandoan.model.CreateOrder;
   ...
   // private String description = "Thanh toán dịch vụ ABC";
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  linearLayout=findViewById(R.id.layoutthanhtoan);
        ...
        btnthanhtoanzalo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        if (code.equals("1")) {
                ...
                // String tokenn = "Đã thanh toán";
                Log.d("test",token);
              // linearLayout.setVisibility(View.INVISIBLE);
             //  thanhtoanrong.setVisibility(View.VISIBLE);
                ZaloPaySDK.getInstance().payOrder(ThanhToan.this, token, "demozpdk://app", new PayOrderListener() {
                            ...
                            public void onPaymentSucceeded(String s, String s1, String s2) {
                                ...
                                startActivity(intent);
                                finish();
                               /* compositeDisposable.add(cuahang.updatezalo(iddonhang, token)
                                        .subscribeOn(Schedulers.io())
                                        .observeOn(AndroidSchedulers.mainThread())
                                        .subscribe(
                                                messageModel -> {
